<x-nosidebar :treeMenu="$treeMenu" :subMenu="$subMenu">
    ...
    <div class="card mb-3">
      <div class="card-body">
        <div class="card-title">
          <h5 class="mb-3">Return Barang Masuk</h5>
          <div class="d-flex flex-column flex-lg-row align-items-center">
            ...
            <div class="ms-auto">
              <div class="d-flex justify-content-end align-items-center">
                ...
                <form action="{{ route('download.rincome') }}" method="POST" class="ms-2">
                  @csrf
  ...
  <script>
    const url = generategetUrl('{{ url('api/inreturn') }}', {
    ...
    const setDate = () => {
      const urls = generategetUrl('{{ url('api/inreturn') }}', {
        fromdate: document.getElementById('fromdate').value,
        enddate: document.getElementById('enddate').value
      })
