                            ...
                            <div class="card shadow">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3 text-sm">
                                        ...
                                        <select class="form-select choice" name="struktur_id" id="struktur_id" required>
                                            <option value="" selected>Pilih Divisi</option>
                                            @foreach ($struktur as $item)
                                                <option value="{{ $item->id }}">{{ $item->hc_unit->unit }} >
                                                    {{ $item->hc_sub_unit->sub_unit }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        <label for="nama_request" class="form-label required">PIC
                                            Request</label>
                                        <input type="text" class="form-control" name="nama_request" id="nama_request"
                            ...
                            <div class="card shadow">
                                <div class="card-body">
                                    <div class="input-group mb-3">
                                        ...
                                        <button class="btn btn-outline-secondary" type="button" id="addons">Data
                                            Barang
                                            (F4)
                                        </button>
                                    </div>
