                         ...
                         <div class="modal-body">
                              <div class="mb-3">
                                   ...
                                   <input type="text" class="form-control" name="bkk" id="bkk"
                                        aria-describedby="emailHelp" placeholder="ex : 0000001 ( tanpa awalan BKK: )">
                              </div>
                              <div class="mb-3">
                                   <label for="tanggal_bkk" class="form-label">Tanggal BKK</label>
                                   <input type="date" class="form-control" name="tanggal_bkk" id="tanggal_bkk"
          ...
          const loadInventorTables = (parameter) => {
               new gridjs.Grid({
                    columns: [{
                         ...
                         formatter:(cell)=>{
                              return gridjs.html(`
                              <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="${cell.id}" data-inventory="${cell.inventory_id}" data-bkk="${cell.bkk}" data-bkkdate="${cell.tanggal_bkk}" data-qty="${cell.qty_in}" data-harga="${cell.harga}">
